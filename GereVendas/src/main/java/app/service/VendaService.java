...
public class VendaService {
	...
	public String delete(Long id) {
		...
		Venda venda = this.vendaRepository.findById(id).orElseThrow(() -> new RuntimeException("Venda não encontrada"));
	...
	public double calcularTotal(List<Produto> produtos) {
		...
		for (Produto produto : produtos) {
			if (produto != null) { 
				Produto produtoEncontrado = produtoService.findById(produto.getId());
